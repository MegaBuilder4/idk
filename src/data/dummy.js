...
export const lineChartData = [ //Video type in advanced analytics
  [ //Stream Views
    ...
    { x: new Date(2022, 8, 1), y: 92.4 },
    { x: new Date(2022, 9, 1), y: 92.4 },
    { x: new Date(2022, 10, 1), y: 92.4 },
    { x: new Date(2022, 11, 1), y: 92.4 },
    { x: new Date(2022, 12, 1), y: 92.4 },
  ],
  [ //Video Views
    { x: new Date(2022, 1, 1), y: 0 },
    { x: new Date(2022, 2, 1), y: 0 },
    ...
    { x: new Date(2022, 8, 1), y: 7.6 },
    { x: new Date(2022, 9, 1), y: 7.6 },
    { x: new Date(2022, 10, 1), y: 7.6 },
    { x: new Date(2022, 11, 1), y: 7.6 },
    { x: new Date(2022, 12, 1), y: 7.6 },
  ],
